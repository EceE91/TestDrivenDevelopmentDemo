...
namespace TestDrivenDevelopmentDemo.Tests.Presentation
{
    public static class CalculatorConstants
    {
        ...
        public const string Message_UnknownOperator = "Huh?";
        public const string Message_Success = "Math is fun!";
        public const string Message_CantDivideByZero = "Divide by zero error!";
